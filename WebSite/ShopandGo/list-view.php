...
<div class="well well-small">
    ...
    <li><a href="products.php"><span class="icon-chevron-right"></span>Accessoires</a></li>
		...
		<li> <a class="totalInCart" href="cart.php"><strong>Total Amount  <span class="badge badge-warning pull-right" style="line-height:18px;">$448.42</span></strong></a></li>
			...
			<li>
			  <div class="thumbnail">
				<a class="zoomTool" href="product_details.php" title="Ajouter au panier"><span class="icon-search"></span> Voir plus</a>
...
<div class="well well-small">
	<div class="row-fluid">
		...
		<div class="btn-group">
		  <a href="product_details.php" class="defaultBtn"><span class=" icon-shopping-cart"></span> Ajouter au panier</a>
		  <a href="product_details.php" class="shopBtn">Voir Plus</a>
		 </div>
			</form>
		</div>
	</div>
	...
	<div class="row-fluid">
		<div class="span2">
			<img src="assets/img/carot.png" alt="">
		</div>
		<div class="span6">
			<h5>Nom du produit </h5>
			<p>
